resource "aws_ssm_parameter" "mysql_sg_id" {
  name  = "/${var.project_name}/${var.environment}/mysql_sg_id" #/roboshop/dev/mysql_sg_id
  type  = "String"
  value = module.mysql_sg.id
}

resource "aws_ssm_parameter" "bastion_sg_id" {
  name  = "/${var.project_name}/${var.environment}/bastion_sg_id" #/roboshop/dev/bastion_sg_id
  type  = "String"
